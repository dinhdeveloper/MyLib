package com.canhdinh.lib.loadingbutton;
...
import com.canhdinh.lib.loadingbutton.utils.DeviceScreenUtils;
import com.canhdinh.lib.loadingbutton.utils.FontUtils;

import static com.canhdinh.lib.loadingbutton.ButtonLoadingAttribute.STATE_ANIMATION_FINISH;
import static com.canhdinh.lib.loadingbutton.ButtonLoadingAttribute.STATE_ANIMATION_START;
import static com.canhdinh.lib.loadingbutton.ButtonLoadingAttribute.STATE_PROGRESS;
...
public class ButtonLoading extends AppCompatTextView {
    ...
    public void initView(Context context, AttributeSet attrs) {
        ...
        buttonGetTouch.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (attribute.getStateShow()) {
            ...
            case STATE_PROGRESS: {
                ...
                canvas.clipRect(RectBoundCanvas, Build.VERSION.SDK_INT >= Build.VERSION_CODES.P ?Region.Op.INTERSECT: Region.Op.REVERSE_DIFFERENCE);
                //background
...
//                canvas.scale(fractionAnimation1, fractionAnimation1, getWidth() / 2, getHeight() / 2);//scale canvas
            ...
            default:
                throw new IllegalStateException("Unexpected value: " + attribute.getStateShow());
        }
    }
