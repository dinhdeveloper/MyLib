package com.canhdinh.lib.roundview;
...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        cornerRadius = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_radius, 0);
        ...
        isRadiusHalfHeight = ta.getBoolean(R.styleable.RoundTextView_rv_radius_half_height, false);
        isWidthHeightEqual = ta.getBoolean(R.styleable.RoundTextView_rv_isWidthHeightEqual, false);
        cornerRadius_TL = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_radius_top_left, 0);
        cornerRadius_TR = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_radius_top_right, 0);
        cornerRadius_BL = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_radius_bottom_left, 0);
        cornerRadius_BR = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_radius_bottom_right, 0);
        isRippleEnable = ta.getBoolean(R.styleable.RoundTextView_rv_isRippleEnable, true);
        underlineThickness = ta.getDimension(R.styleable.RoundTextView_rv_underlineThickness, 1f);
