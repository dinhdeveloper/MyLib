package com.canhdinh.lib.kalert;
...
public class KAlertDialog extends AlertDialog implements View.OnClickListener {
    ...
    private final ProgressHelpers mProgressHelper;
    ...
    public KAlertDialog(Context context, int alertType) {
        ...
        mProgressHelper = new ProgressHelpers(context);
    ...
    public ProgressHelpers getProgressHelper () {
