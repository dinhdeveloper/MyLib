package com.canhdinh.lib.colorpicker;
...
public class ColorPickerDialog {
	...
	final OnPickerListener listener;
	final View viewHue;
	 ...
	 */
	public ColorPickerDialog(final Context context, int color, OnPickerListener listener) {
	 ...
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public ColorPickerDialog(final Context context, int color, boolean supportsAlpha, OnPickerListener listener) {
