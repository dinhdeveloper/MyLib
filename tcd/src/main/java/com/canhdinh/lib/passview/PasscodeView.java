package com.canhdinh.lib.passview;
...
import static com.canhdinh.lib.passview.PasscodeView.PasscodeViewType.TYPE_CHECK_PASSCODE;
import static com.canhdinh.lib.passview.PasscodeView.PasscodeViewType.TYPE_SET_PASSCODE;
...
public class PasscodeView extends FrameLayout implements View.OnClickListener {
    ...
    private String firstInputTip = "Nhập mật mã gồm 6 chữ số";
    private String secondInputTip = "Nhập lại mật mã mới";
    private String wrongLengthTip = "Nhập mật mã gồm 6 chữ số";
    private String wrongInputTip = "Mật mã không khớp";
    private String correctInputTip = "Mật mã chính xác";
    ...
    public PasscodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        firstInputTip = firstInputTip == null ? "Nhập mật mã gồm 6 chữ số" : firstInputTip;
        secondInputTip = secondInputTip == null ? "Nhập lại mật mã mới" : secondInputTip;
        wrongLengthTip = wrongLengthTip == null ? firstInputTip : wrongLengthTip;
        wrongInputTip = wrongInputTip == null ? "Mật mã không khớp" : wrongInputTip;
        correctInputTip = correctInputTip == null ? "Mật mã chính xác" : correctInputTip;
