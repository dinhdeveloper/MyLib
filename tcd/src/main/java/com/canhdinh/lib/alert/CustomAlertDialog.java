...
public class CustomAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public interface OnSweetClickListener {
        void onClick(CustomAlertDialog sweetAlertDialog);
    }
...
//                    mButtonsContainer.setVisibility(View.GONE);
    ...
    public CustomAlertDialog setNeutralClickListener(OnSweetClickListener listener) {
    ...
    public CustomAlertDialog setConfirmButton(String text, OnSweetClickListener listener) {
        this.setConfirmText(text);
        this.setConfirmClickListener(listener);
        return this;
    }

    public CustomAlertDialog setConfirmButton(int resId, OnSweetClickListener listener) {
    ...
    public CustomAlertDialog setCancelButton(String text, OnSweetClickListener listener) {
        this.setCancelText(text);
        this.setCancelClickListener(listener);
        return this;
    }

    public CustomAlertDialog setCancelButton(int resId, OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
        setCancelButton(text, listener);
        return this;
    }

    public CustomAlertDialog setNeutralButton(String text, OnSweetClickListener listener) {
        this.setNeutralText(text);
        this.setNeutralClickListener(listener);
        return this;
    }

    public CustomAlertDialog setNeutralButton(int resId, OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
