...
public class AlertDialog extends Dialog implements View.OnClickListener {
    ...
    private AlertDialog.OnSweetClickListener mCancelClickListener;
    private AlertDialog.OnSweetClickListener mConfirmClickListener;
    private AlertDialog.OnSweetClickListener mNeutralClickListener;
    ...
    public AlertDialog hideConfirmButton() {
        this.mHideConfirmButton = true;
        return this;
    }

    public interface OnSweetClickListener {
        void onClick(AlertDialog sweetAlertDialog);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alert_dialog_k);
...
//                    mButtonsContainer.setVisibility(View.GONE);
    ...
    public AlertDialog setTitleText(int resId) {
    ...
    public AlertDialog setCancelClickListener(AlertDialog.OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public AlertDialog setConfirmClickListener(AlertDialog.OnSweetClickListener listener) {
        mConfirmClickListener = listener;
        return this;
    }

    public AlertDialog setNeutralText(String text) {
        mNeutralText = text;
    ...
    public AlertDialog setNeutralClickListener(AlertDialog.OnSweetClickListener listener) {
    ...
    public AlertDialog setConfirmButton(String text, AlertDialog.OnSweetClickListener listener) {
        this.setConfirmText(text);
        this.setConfirmClickListener(listener);
        return this;
    }

    public AlertDialog setConfirmButton(int resId, AlertDialog.OnSweetClickListener listener) {
    ...
    public AlertDialog setCancelButton(String text, AlertDialog.OnSweetClickListener listener) {
        this.setCancelText(text);
        this.setCancelClickListener(listener);
        return this;
    }

    public AlertDialog setCancelButton(int resId,AlertDialog.OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
        setCancelButton(text, listener);
        return this;
    }

    public AlertDialog setNeutralButton(String text, AlertDialog.OnSweetClickListener listener) {
        this.setNeutralText(text);
        this.setNeutralClickListener(listener);
        return this;
    }

    public AlertDialog setNeutralButton(int resId, AlertDialog.OnSweetClickListener listener) {
        String text = getContext().getResources().getString(resId);
     ...
     */
    public AlertDialog setContentTextSize(int value) {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.cancel_button) {
            ...
            if (mNeutralClickListener != null) {
                mNeutralClickListener.onClick(AlertDialog.this);
            } else {
                dismissWithAnimation();
            }
        }
