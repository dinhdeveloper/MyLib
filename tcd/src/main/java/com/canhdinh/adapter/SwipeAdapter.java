...
import com.canhdinh.model.Employee;
import com.canhdinh.lib.R;
import com.canhdinh.lib.swipe.SwipeRevealLayout;
import com.canhdinh.lib.swipe.ViewBinderHelper;
        ...
        SwipeViewHolder(@NonNull View itemView) {
            ...
            txtEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(context, "edit"+getAdapterPosition(), Toast.LENGTH_SHORT).show();
                }
            });
